...
class NYPD_OneEnv(Dataset):
    def __init__(self, env):
        df = pd.read_csv("/home/kxj200023/data/NYPD/" + str(env) + ".csv", encoding='latin-1', low_memory=False)
...
class SensitiveImageFolder(ImageFolder):
    def __init__(self,
        ...
        self.y = torch.tensor(self.targets)
        self.z = []
        for i in range(len(self.samples)):
            path = self.samples[i][0]
            file_name = path.split('/')[-1]
            temp_z = self.dict[file_name][2]
...
class CCMNIST1(MultipleEnvironmentImageFolder):
    ...
    ENVIRONMENTS = [0, 1, 2]
    def __init__(self, root, test_envs,hparams):
        self.dir = os.path.join("/home/kxj200023/data/CCMNIST1/")
...
class FairFace(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, test_envs,hparams):
        self.dir = os.path.join("/home/kxj200023/data/FairFace/")
        super().__init__(self.dir, test_envs, hparams['data_augmentation'], hparams)
...
class YFCC(MultipleEnvironmentImageFolder):
    ...
    ENVIRONMENTS = ['0', '1', '2']
    def __init__(self, root, test_envs,hparams):
        self.dir = os.path.join("/home/kxj200023/data/YFCC/")
        super().__init__(self.dir, test_envs, hparams['data_augmentation'], hparams)
