...
def _hparams(algorithm, dataset, random_seed, test_envs, step):
    ...
    elif algorithm == 'MBDG_Meta' or algorithm == 'MBDG_Meta_Ab1':
    ...
    if dataset == 'NYPD':
        _hparam('batch_size', 512, lambda r: 512)
    ...
    if algorithm in ['MBDG_Meta', 'MBDG_Meta_Ab1', 'MBDG', 'MBDG_Reg', 'MBDG_DA', 'MBDA', 'MBDG_3', 'MBDG_WF']:
        _hparam('k_shot', 3, lambda r: 3)
        _hparam('k_query', 5, lambda r: 5)
        ...
        _hparam('update_step', 1, lambda r: 1)
